...
import org.zibble.inventoryframework.menu.inventory.buttonmenus.EnchantingTableMenu;
import org.zibble.inventoryframework.protocol.Enchant;

/**
 * Class meant to be used a type parameter for {@link MenuItem} class to allow displaying enchants in {@link EnchantingTableMenu}
 */
public class EnchantOption {
     ...
     */
    public static EnchantOption shown(int xpLevelCost, Enchant enchantment, int enchantLevel) {
